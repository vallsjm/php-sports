...
{
    abstract public function readFromFile(string $fileName, ActivityCollection $activities = null) : ActivityCollection;
    abstract public function saveToFile(ActivityCollection $activities, string $fileName, bool $pretty = false);

    abstract public function readFromBinary(string $data, ActivityCollection $activities = null) : ActivityCollection;
